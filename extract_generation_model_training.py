...
alt_model_path = "F:/VSprograms/models/Qwen/Qwen2-1.5B-Instruct-personal4" # Path of the untrained base model
processor_model_path = "Qwen/Qwen2-1.5B-Instruct" # Tokenizer / Processor of the base model
new_model = "F:/VSprograms/models/Qwen/custom_qwen_model_eg4_basic" # Save path for the trained extract generation model
...
eval_dataset = datasets.concatenate_datasets([e_dataset, e2_dataset]) # Mix typical data and long data samples to get a representative evaluation

...
alt_model_path = "F:/VSprograms/models/Qwen/Qwen2-1.5B-Instruct-personal4" # Quantized untrained base model
processor_model_path = "Qwen/Qwen2-1.5B-Instruct" # Tokenizer / Processor of the base model
new_model = "F:/VSprograms/models/Qwen/custom_qwen_model_e2_basic" # Save path for the trained extraction model
...
dataset_path = "F:/VSprograms/extract_dataset.jsonl" # Training dataset
dataset = load_dataset('json', data_files=dataset_path, split='train' )
dataset = dataset.select(range(50000))

e_dataset_path = "F:/VSprograms/extract_dataset.jsonl" # Evaluation dataset
...
def prepare_training_example(i):
    ...
    # Extraction model specific prompt

...
datasize = 1000# 1000
generated_tokens1 = 2000
generated_tokens2 = 600
...
second_model_path = "F:/VSprograms/models/Qwen/custom_qwen_model_eg4_basic"
#"F:/VSprograms/models/Qwen/Qwen2-1.5B-Instruct-personal4"#"Qwen/Qwen2-7B-Instruct-GPTQ-Int4"#"F:/VSprograms/models/Qwen/Qwen2-1.5B-Instruct-personal4"
    ...
    with open(dataset_path, 'r', encoding='utf-8') as file:
        for chunk in read_jsonl_in_chunks(file, chunk_size):
            for entry in chunk:
                ...
                if not e_check:
                    continue
                top_answer_indices, top_answer_chunks = evaluate_chunks(question, chunks_xml, eval_embed_model, 9)

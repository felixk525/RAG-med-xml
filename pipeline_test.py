...
alt_model_path = "F:/VSprograms/models/Qwen/custom_qwen_model_9_basic" # The trained generation model
...
# Embedding the chunks and retrieving the top k chunks. K in this case is 3
...
evaluated_lines = 0
# Generating responsed with the retrieved chunks from the embedding model
with tqdm(total=evaluate_range, desc="Processing entries", unit="lines") as progress_bar:
    for result in results:
        if evaluated_lines >= evaluate_range:
            break

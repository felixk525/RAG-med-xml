...
# 100 recommended due to memory limits
chunk_size = 100
chunk_iterator = pd.read_csv(file_path, chunksize=chunk_size)
failures = 0
empty = 0
exclude_sections = True
# Process 3000 chunks for a total of 300000 files
num_chunks = 3000  
output_file = "D:/Bachelorarbeit/XML_training_dataset.jsonl" # Saving in a JSONL (JSON Lines) file

# Possible questions for the various sections
...
def chunking(file, chunk_size = 5):
    ...
    for i, line in enumerate(file):
        ...
        if len(current_chunk) == chunk_size or i == len(file) - 1: 
        ...
        try:
            ...
            for i in range(0, chunk_size):
                ...
                for section in sections:
                    ...
                    if exclude_sections and any(excluded_section in section_id for excluded_section in ["Vormedikation", "Therapie"]):
                        continue  # Exlude sections to create unseen data
